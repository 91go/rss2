...
3. 买某样东西之前，需要经过哪几点思考？
   ...
   2. 功能层面
      ...
      3. **看东西是否可以七天无理由**，如果不能就不买；到手后，**看看是否能够提供预想的功能？** 不合适就退货，不将就；比如始祖鸟lefroy速干裤、电蒸锅、足部按摩器之类的太多了；比如`atom ar`无法提供冬天的防水防风需求；
      4. 需求是否为真需求？比如除湿、室内换气是真需求，但是烤箱及空气炸锅就是伪需求；
      5. 是否超出了当前需求？是否属于不易维持的高阶需求？比如同时拥有多台mac，多块显示器；维持成本较高，没有意义；
   3. 收纳层面
      1. 是否轻量化？是否可折叠？是否可收纳？
